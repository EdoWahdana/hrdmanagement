            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Input Data Pelamar</h3>
      ...
      if (!empty($_FILES["nama_file"]["tmp_name"]))
      {
        ...
        {			
          ...
          if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
            $sql="INSERT INTO recruitment (idpelamar,namalengkap,alamat,tanggal_interview,nomorhp,posisi,status,gambar) VALUES
                  ('$idpelamar','$namalengkap','$alamat','$tanggal_interview','$nomorhp','$posisi','$status','$gambar')";
            $res=mysqli_query($koneksi, $sql) or die (mysqli_error());
            //echo "Gambar berhasil dikirim ke direktori".$gambar;
                  echo "<script>alert('Data berhasil dimasukan!'); window.location ='recruitment.php'</script>";	   
          } else {
       ...
       echo '<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Anda Belum Memilih Gambar</div>';
			...
			?>
                <div class="box-body">
                <form class="form-horizontal style-form" action="input-recruitment.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">ID Pelamar</label>
                              <div class="col-sm-4">
                                  <input name="idpelamar" type="text" id="idpelamar" class="form-control" placeholder="ID Pelamar" autocomplete="off" autofocus="on" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Lengkap</label>
                              <div class="col-sm-4">
                            <input name="namalengkap" type="text" id="namalengkap" class="form-control" placeholder="Nama Lengkap" autocomplete="off" required />
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                              <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='tanggal_interview' id="tanggal_interview" placeholder='Tanggal Interview' autocomplete='off' required='required' />
                            </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nomor HP</label>
                              <div class="col-sm-4">
                            <input name="nomorhp" type="text" id="nomorhp" class="form-control" placeholder="Nomor HP" autocomplete="off" required />
                            </div>
                          </div>
                          <div class="form-group">
                    ...
                    ?>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Foto Pelamar (3x4)</label>
                              <div class="col-sm-4">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="recruitment.php" class="btn btn-sm btn-danger">Batal </a>
                              </div> 
                          </div>
                      </form>
                </div><!-- /.box-body -->
