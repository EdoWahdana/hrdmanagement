...
<?php include "waktu.php"; ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Gaji
            <small>HRD Management System ALTER</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Import Gaji Karyawan</h3>
...
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = "INSERT INTO gaji (nik, nama, tanggal, departemen, jabatan, status, gapok, bpjs, lembur, norek) VALUES 
                      ('$nik', '$nama', '$tanggal', '$departemen', '$jabatan', '$status', '$gapok', '$bpjs', '$lembur', '$norek')";
...
<form name="myForm" id="myForm" onSubmit="return validateForm()" action="gaji_importxls.php" method="post" enctype="multipart/form-data">
