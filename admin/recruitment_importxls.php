...
//             kosongkan tabel pegawai
             $truncate ="TRUNCATE TABLE recruitment";
...
//       membaca data (kolom ke-1 sd terakhir)
      $idpelamar            = $data->val($i, 1);
      $namalengkap          = $data->val($i, 2);
      $alamat               = $data->val($i, 3); 
      $tanggal_interview    = $data->val($i, 4);    
      $nomorhp              = $data->val($i, 5); 
      $posisi               = $data->val($i, 6);
      $status               = $data->val($i, 7);
 
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = "INSERT INTO recruitment (idpelamar, namalengkap, alamat, tanggal_interview, nomorhp, posisi, status) VALUES 
                      ('$idpelamar', '$namalengkap', '$alamat', '$tanggal_interview', '$nomorhp', '$posisi', '$status')";
