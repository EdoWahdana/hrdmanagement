...
<?php include "waktu.php"; ?>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                 ...
                 <?php
            $kd = $_GET['id'];
			$sql = mysqli_query($koneksi, "SELECT * FROM gaji WHERE nik='$kd'");
	...
	{			
      ...
      $sql="UPDATE gaji SET nik='$nik', nama='$nama', tanggal='$tanggal', departemen='$departemen', jabatan='$jabatan', status='$status', gapok='$gapok',  bpjs='$bpjs',  lembur='$lembur',  norek='$norek', gambar='$gambar' WHERE nik='$kd'";
			...
			?>
                ...
                <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                              <input type='text' class="input-group date form-control" value="<?php echo $row['tanggal']; ?>" data-date="" data-date-format="yyyy-mm-dd" name='tanggal' id="tanggal" placeholder='Tanggal' required />
                            </div>
                          </div>
                          <div class="form-group">
                ...
                <?php } ?>
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="gapok" type="text" id="gapok" class="form-control" value="<?php echo $row['gapok']; ?>" placeholder="Gaji Pokok" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="bpjs" type="text" id="bpjs" class="form-control" value="<?php echo $row['bpjs']; ?>" placeholder="BPJS" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="lembur" type="text" id="lembur" class="form-control" value="<?php echo $row['lembur']; ?>"  placeholder="Lembur" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="norek" type="text" id="norek" class="form-control" value="<?php echo $row['norek']; ?>"  placeholder="Nomor Rekening" autocomplete="off" required />
